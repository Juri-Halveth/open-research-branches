...
[`../catalog/branches.json`](../catalog/branches.json). Generated binaries and
visual QA renders are excluded from the Git source tree; a dedicated branch may
publish its reviewed, reproducible build source.

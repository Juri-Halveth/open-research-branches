...
```mermaid
flowchart LR
  S["Specific scene or original source"] --- T["What does the story show?"]
  S --- E["Whose interests and choices?"]
  S --- A["What alternative could be designed?"]
  A --- M["New model with defined rules"]
  M --- P["Separate test with data and controls"]
```

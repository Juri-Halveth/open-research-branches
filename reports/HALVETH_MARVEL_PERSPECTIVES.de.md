...
```mermaid
flowchart LR
  S["Konkrete Szene oder Originalquelle"] --- T["Was zeigt die Erzählung?"]
  S --- E["Wessen Interessen und Entscheidungen?"]
  S --- A["Welche Alternative wäre denkbar?"]
  A --- M["Neues Modell mit definierten Regeln"]
  M --- P["Eigene Prüfung mit Daten und Kontrollen"]
```

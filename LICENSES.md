...
| `reports/FREE_NEWS_012_ALICE_MEDIA_REFERENT_AND_AGENCY_AUDIT.md` and the research records `README.md`, `sources.json`, `candidate-works.json`, `local-anchors.json`, and `reconstruction-cycle.json` under `branches/alice-media-referent-and-agency-audit/` from their first public commit | [Juri Public-Interest Research Permission 1.0](LICENSE-JURI-PUBLIC-INTEREST.md) |
